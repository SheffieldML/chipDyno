...
%\footnote{We would like to acknowledge Simo S\"arkk\"a, Academy Research Fellow, Aalto University, Finland for his valuable suggestions and guidelines.} 
...
\institute{
    ...
    \and Simo S\"arkk\"a %(\Letter)
        \at Academy Research Fellow  
...
%\textbf{Authors and Contributors}: This work was carried out in close collaborationbetween the co-authors. NDL preliminarily defined the research theme. MAR and NLD contributed an early design of the system. SS bridged the mechanistic model and GP model. MAR implemented it. NDL refined the system development. MAR wrote the manuscript, SS and NLD edited it. All the authors have contributed to, seen and approved the final manuscript.
