...
\begin{frame}
\frametitle{Data Set: Gene Expression, TF and Connectivity } 
\textbf{Gene Expression level:} Point estimate of expression extracted from gene expression data using tool {\color{blue}puma} ~\cite{p6}.\\  
\textbf{Transcription Factors:} {\color{blue}(EDGEdb)} \cite{{p7}} contains the sequence information of 934 TF and their DNA binding domains. \\
\textbf{Connectivity between Genes and TF:} Evidence code of Wormnet \footnote{http://www.functionalnet.org/wormnet/about.html} and ~\cite{p5} represent {\color{blue} different (21) types of relations} between genes.
We choose following four relations-
\begin{itemize}
...
\bibitem[Pearson, et al. 2009]{p6} R. Pearson and X. Liu and G. Sanguinetti and M. Milo and N.D. Lawrence and M. Rattray (2009) 
