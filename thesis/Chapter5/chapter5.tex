...
\begin{figure}
	\centering
		...
		\includegraphics[width=\textwidth,keepaspectratio]{enrichnoCore.png}
		\rule{35em}{0.5pt}
...
%  \centering 
    \begin{tabular}{l l l l l }
      \toprule
	\textbf{Annotation Cluster 1}	& \textbf{Enrichment Score: 2.16}	& \textbf{Count}	& \textbf{P\_Value}	& \textbf{Ben}\\ %Benjamini
      \midrule
