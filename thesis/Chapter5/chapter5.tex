...
\begin{figure}
 \begin{center}
 \includegraphics[width=.47\textwidth]{fXkern.png}
 \includegraphics[width=.47\textwidth]{fYkern.png}
...
\begin{figure}
 \begin{center}
 %\includegraphics[width=\textwidth]{diagrams/figure_12.pdf}
...
% % \begin{table*}[t]
% % \vspace{3mm}
% % \caption{Gene ontology enrichment analysis from functional annotation clustering of cluster 
% % number 197 using DAVID.\label{table:funAnno}}
% % \begin{center}
% % {\centering \small \begin{tabular}{|c|c|c|c|c|}
% % \hline
% % Annotation Cluster 1	& Enrichment Score: 2.16	& Count	& P\_Value	& Benjamini\\ \hline
% % GOTERM\_CC\_FAT	& organelle inner membrane		& 9	& 3.0E-5	& 4.5E-3\\ \hline
% % GOTERM\_CC\_FAT	& mitochondrial inner membrane		& 8	& 1.6E-4	& 1.2E-2\\ \hline
% % GOTERM\_CC\_FAT	& organelle membrane			& 12	& 2.8E-4	& 1.4E-2\\ \hline
% % GOTERM\_CC\_FAT	& mitochondrial membrane		& 8	& 6.1E-4	& 2.3E-2\\ \hline
% % GOTERM\_CC\_FAT	& mitochondrial envelope 		& 8	& 8.7E-4	& 2.6E-2\\ \hline
% % GOTERM\_CC\_FAT	& organelle envelope			& 9	& 1.2E-3	& 3.1E-2\\ \hline
% % GOTERM\_CC\_FAT	& envelope				& 9	& 1.3E-3	& 2.7E-2\\ \hline
% % SP\_PIR\_KEYWORDS	&mitochondrion inner membrane	& 5	& 3.8E-3	& 4.2E-1\\ \hline
% % GOTERM\_CC\_FAT	& mitochondrial part			& 8	& 4.6E-3	& 8.3E-2\\ \hline
% % SP\_PIR\_KEYWORDS	& mitochondrion			& 9	& 5.8E-3	& 3.5E-1\\ \hline
% % GOTERM\_CC\_FAT	& mitochondrial membrane part		& 3	& 1.6E-2	& 1.9E-1\\ \hline
% % GOTERM\_BP\_FAT	& transmembrane transport		& 6	& 3.1E-2	& 8.8E-1\\ \hline
% % GOTERM\_MF\_FAT	& \makecell{hydrogen ion transmembrane \\ transporter activity} 
% %   & 3	& 3.3E-2  & 9.9E-1\\ \hline
% % GOTERM\_MF\_FAT & \makecell{monovalent inorganic cation \\ transmembrane transporter activity} 
% %   & 3	& 3.6E-2 & 9.4E-1\\ \hline
% % GOTERM\_MF\_FAT	& \makecell{inorganic cation transmembrane \\ transporter activity}
% %   & 3	& 7.1E-2 & 8.9E-1\\ \hline
% % SP\_PIR\_KEYWORDS &transit peptide			& 5	& 7.4E-2	& 5.8E-1\\ \hline
% % GOTERM\_CC\_FAT	& mitochondrion 			& 10	& 7.6E-2	& 5.5E-1\\ \hline
% % UP\_SEQ\_FEATURE	& transit peptide:Mitochondrion	& 5	& 1.0E-1	& 1.0E0\\ \hline
% % KEGG\_PATHWAY	& Oxidative phosphorylation		& 3	& 1.0E-1	& 8.6E-1\\ \hline
% % GOTERM\_BP\_FAT	& \makecell{generation of precursor \\ metabolites and energy} & 3	& 2.6E-1 & 9.9E-1\\ \hline
% % \end{tabular}\par}
% % \end{center}
% % \end{table*}
...
%% Our data also contained repeat measurements that could be accounted for by assuming each repeat was an observation of the same underlying function but corrupted by an independent Gaussian noise sample for each observation.

%% At present, majority of the state of the art models do not capture the structure of the time-series
%% gene expression data. While it is a very common practice to repeat various complex experiments
%% multiple times and so is to produce series of replicated data.
%% When dealing with biological replicates specially gene expression time-series, 
%% crude averaging of the expression values may lead to the 
%% discarding of valuable information. Rather if we can considered all of the replicates together and 
%% build a temporal model that may provide us more accurate results and also show the exact nature or 
%% characteristics.
...
An appropriate general model that can capture the dependencies between all the data points and conditions is known as the linear model of coregionalization (LMC) is a model where output is a linear combination of independent random functions. 
...
\begin{figure}
	\centering
		\includegraphics[width=\textwidth,keepaspectratio]{barGraphNoCore10000g.png}
		\rule{35em}{0.5pt}
