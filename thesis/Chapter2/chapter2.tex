...
\end{equation}
where the unconditioned $p\left(\textbf{m}_1\right)$ is called the \lq prior\rq to get the idea even before the observation of $\textbf{m}_2$. The conditional density $p\left(\textbf{m}_2|\textbf{m}_1\right)$ is the \lq likelihood\rq, $p\left(\textbf{m}_2\right)$ is the \lq marginal likelihood\rq and the conditioned density $p\left(\textbf{m}_1|\textbf{m}_2\right)$ is the \lq posterior\rq. The \lq marginal likelihood\rq $p\left(\textbf{m}_2\right)$ is independent of $\textbf{m}_1$ and used as a normalizing constant. 
