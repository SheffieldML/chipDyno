...
#% 	chipStatMatrixInverter.m version 0.1.0
...
LcoeffXYT[1]=factor*(1-factor^2)^-1*beta^2/(UcoeffInvSigma[1]*(UcoeffInvSigma[1]+beta^2*lambda)) ## Need to check 'lambda'-s dimention
LcoeffId[1]=-factor
